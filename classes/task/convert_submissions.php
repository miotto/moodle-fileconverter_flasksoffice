 ...
 *             based on code by Jan Dageförde, University of Münster <jan.dagefoerde@ercis.uni-muenster.de> and
 *             Matt Porritt <mattp@catalyst-au.net>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
namespace fileconverter_flasksoffice\task;
...
class convert_submissions extends scheduled_task {
    ...
    public function get_name() {
        return get_string('preparesubmissionsforannotation', 'fileconverter_flasksoffice');
    }
    ...
    public function execute() {
        ...
        foreach ($pendingconversions as $pendingconversion) {
            ...
            if ($file) {
                mtrace('flasksoffice: Processing conversions for file id: ' . $pendingconversion->sourcefileid);
                $conversions = \core_files\conversion::get_conversions_for_file($file, $pendingconversion->targetformat);

                mtrace('flasksoffice: Found: ' . count($conversions)
